...
/* -- _init functions for keccak -- */

/* .. c:function:: $DECL */
extern void cf_keccak_224_init(cf_sha3_context *ctx);

/* .. c:function:: $DECL */
extern void cf_keccak_256_init(cf_sha3_context *ctx);

/* .. c:function:: $DECL */
extern void cf_keccak_384_init(cf_sha3_context *ctx);

/* .. c:function:: $DECL
 * Sets up `ctx` ready to hash a new message.
 */
extern void cf_keccak_512_init(cf_sha3_context *ctx);
