...
#define DOMAIN_HASH_KECCAK_PAD  0x01
...
{
  pad(ctx, ctx->padding, ctx->rate - ctx->npartial);
...
void cf_sha3_224_init(cf_sha3_context *ctx)
{
  ...
  ctx->padding = DOMAIN_HASH_PAD;
}

/* KECCAK 224 */
void cf_keccak_224_init(cf_sha3_context *ctx)
{
  sha3_init(ctx, 1152, 448);
  ctx->padding = DOMAIN_HASH_KECCAK_PAD;
}
...
/* KECCACK 256 */
void cf_keccak_256_init(cf_sha3_context *ctx)
{
  sha3_init(ctx, 1088, 512);
  ctx->padding = DOMAIN_HASH_KECCAK_PAD;
}
...
/* KECCAK-384 */
void cf_keccak_384_init(cf_sha3_context *ctx)
{
  sha3_init(ctx, 832, 768);
  ctx->padding = DOMAIN_HASH_KECCAK_PAD;
}
...
/* KECCAK-512 */
void cf_keccak_512_init(cf_sha3_context *ctx)
{
  sha3_init(ctx, 576, 1024);
  ctx->padding = DOMAIN_HASH_KECCAK_PAD;
}
