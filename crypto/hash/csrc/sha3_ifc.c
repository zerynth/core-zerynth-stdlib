...
C_NATIVE(zs_sha3_init){
    ...
    switch(hashtype){
        case SHA224: cf_sha3_224_init(PSEQUENCE_BYTES(bres)); break;
        case SHA256: cf_sha3_256_init(PSEQUENCE_BYTES(bres)); break;
        case SHA384: cf_sha3_384_init(PSEQUENCE_BYTES(bres)); break;
        case SHA512: cf_sha3_512_init(PSEQUENCE_BYTES(bres)); break;
    }
    ACQUIRE_GIL();
    *res = bres;
...
C_NATIVE(zs_sha3_context){
    ...
    switch(hashtype){
        case SHA224:{ 
            ...
            hcc->init_hash = cf_sha3_224_init;
        ...
        case SHA256:{ 
            ...
            hcc->init_hash = cf_sha3_256_init;
        ...
        case SHA384:{ 
            ...
            hcc->init_hash = cf_sha3_384_init;
        ...
        case SHA512:{ 
            ...
            hcc->init_hash = cf_sha3_512_init;
