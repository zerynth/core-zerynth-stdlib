...
mbedtls_md_info_t mbedtls_sha256_hwcrypto_info = {
    ...
    32,
    64,
    NULL, // zerynth_hwcrypto_digest_sha256_starts
    NULL, // zerynth_hwcrypto_digest_sha256_update
    NULL, // zerynth_hwcrypto_digest_sha256_finish
    NULL, // zerynth_hwcrypto_digest_sha256
    NULL, // zerynth_hwcrypto_digest_sha256_ctx_alloc
    NULL, // zerynth_hwcrypto_digest_sha256_ctx_free
    NULL,
    NULL,
};
