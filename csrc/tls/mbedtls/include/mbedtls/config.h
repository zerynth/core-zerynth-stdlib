...
// #define MBEDTLS_PLATFORM_CALLOC_MACRO        gc_calloc /**< Default allocator macro to use, can be undefined */
// #define MBEDTLS_PLATFORM_FREE_MACRO            gc_free /**< Default free macro to use, can be undefined */
