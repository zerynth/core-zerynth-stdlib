...
#define FCLK_SLOW() { vhalSpiDone(spi_drv); spi_conf->clock = slow_clock; printf("-->%i\n",vhalSpiInit(spi_drv, spi_conf)); }
...
static uint32_t slow_clock = 700000;
