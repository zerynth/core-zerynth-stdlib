...
go_to_sleep = __pwr_go_to_sleep

wakeup_reason = __pwr_wakeup_reason

set_status_byte = __pwr_set_status_byte

get_status_byte = __pwr_get_status_byte

get_status_size = __pwr_get_status_size